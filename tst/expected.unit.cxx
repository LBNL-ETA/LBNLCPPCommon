...
TEST(ExpectedExtTest, OperatorPipe_WithValue)
{
    auto res = lbnl::make_expected<int, std::string>(3) |
               [](int x) { return lbnl::make_expected<int, std::string>(x + 2); };
...
{
    auto res = lbnl::make_expected<int, std::string>(2) | [](int x) {
        return lbnl::make_expected<int, std::string>(x * 3);
...
TEST(ExpectedExtTest, OperatorPipe_WithError)
{
    auto res = lbnl::make_unexpected<int, std::string>("Oops") |
               [](int x) { return lbnl::make_expected<int, std::string>(x + 10); };
